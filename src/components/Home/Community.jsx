  ...
  return (
    <div className='my-10'>
      ...
      <div className='my-10 flex flex-col lg:flex-row px-20 md:px-60 lg:px-40 space-y-10 lg:space-y-0 lg:space-x-32'>
        <div className='flex flex-col items-center  space-y-2 shadow-md rounded py-10 lg:px-10 font-inter' style={{ boxShadow: '0px 4px 6px rgba(171, 190, 209, 0.2)' }}>
          <img src={I1} alt="Icon" className='w-8 h-8 md:w-12 md:h-12 mx-auto' />
          <h2 className='text-[#4D4D4D] text-center text-xl font-medium md:text-3xl md:font-semibold'>Membership Organisations</h2>
        ...
        <div className='flex flex-col items-center  space-y-2 shadow-md rounded py-10 lg:px-10 font-inter' style={{ boxShadow: '0px 4px 6px rgba(171, 190, 209, 0.2)' }}>
          ...
          <h2 className='text-[#4D4D4D] text-center text-xl font-medium md:text-3xl md:font-semibold'>National Associations</h2>
          <p className='text-[#717171] text-center text-xs'>Our membership management software provides full automation of membership renewals and payments</p>
        </div>
        <div className='flex flex-col items-center  space-y-2 shadow-md rounded py-10 lg:px-10 font-inter' style={{ boxShadow: '0px 4px 6px rgba(171, 190, 209, 0.2)' }}>
          <img src={I3} alt="Icon" className='w-8 h-8 md:w-12 md:h-12 mx-auto' />
          <h2 className='text-[#4D4D4D] text-center text-xl font-medium md:text-3xl md:font-semibold'>Clubs And Groups</h2>
          <p className='text-[#717171] text-center text-xs'>Our membership management software provides full automation of membership renewals and payments</p>
        </div>
      </div>
    </div>
